...
This file defines the Coach-regulated neural network for policy estimation
'''

import torch
from agent.models.encoder import Encoder

class CoachRegNN(torch.nn.Module):
    '''
    ...
    def __init__(self):
        ...
        super(CoachRegNN, self).__init__()
